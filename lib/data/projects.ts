...
// Uses react-icons/si component names for consistent cross-platform rendering
export const TECH_META: Record<string, { iconName: string; color: string; bg: string }> = {
  'Node.js': { iconName: 'SiNodedotjs', color: '#6DA55F', bg: 'rgba(109,165,95,0.10)' },
  'Express.js': { iconName: 'SiExpress', color: '#999999', bg: 'rgba(153,153,153,0.10)' },
  'NestJS': { iconName: 'SiNestjs', color: '#E0234E', bg: 'rgba(224,35,78,0.10)' },
  'PostgreSQL': { iconName: 'SiPostgresql', color: '#336791', bg: 'rgba(51,103,145,0.10)' },
  'MySQL': { iconName: 'SiMysql', color: '#4479A1', bg: 'rgba(68,121,161,0.10)' },
  'MongoDB': { iconName: 'SiMongodb', color: '#47A248', bg: 'rgba(71,162,72,0.10)' },
  'Redis': { iconName: 'SiRedis', color: '#DC382D', bg: 'rgba(220,56,45,0.10)' },
  'Docker': { iconName: 'SiDocker', color: '#2496ED', bg: 'rgba(36,150,237,0.10)' },
  'Kubernetes': { iconName: 'SiKubernetes', color: '#326CE5', bg: 'rgba(50,108,229,0.10)' },
  'RabbitMQ': { iconName: 'SiRabbitmq', color: '#FF6600', bg: 'rgba(255,102,0,0.10)' },
  'Nginx': { iconName: 'SiNginx', color: '#009900', bg: 'rgba(0,153,0,0.10)' },
  'JWT': { iconName: 'SiJsonwebtokens', color: '#D63AFF', bg: 'rgba(214,58,255,0.10)' },
  'Stripe API': { iconName: 'SiStripe', color: '#635BFF', bg: 'rgba(103,91,255,0.10)' },
  'Socket.io': { iconName: 'SiSocketdotio', color: '#818181', bg: 'rgba(200,200,200,0.10)' },
  'React': { iconName: 'SiReact', color: '#61DAFB', bg: 'rgba(97,218,251,0.10)' },
  'TypeScript': { iconName: 'SiTypescript', color: '#3178C6', bg: 'rgba(49,120,198,0.10)' },
  'TypeORM': { iconName: 'SiTypeorm', color: '#E83524', bg: 'rgba(232,53,36,0.10)' },
  'Swagger': { iconName: 'SiSwagger', color: '#85EA2D', bg: 'rgba(133,234,45,0.10)' },
  'Jest': { iconName: 'SiJest', color: '#C21325', bg: 'rgba(194,19,37,0.10)' },
  'Prisma': { iconName: 'SiPrisma', color: '#B6BEDC', bg: 'rgba(45,55,72,0.10)' },
  'GraphQL': { iconName: 'SiGraphql', color: '#E10098', bg: 'rgba(225,0,152,0.10)' },
  'Commander.js': { iconName: 'SiGnubash', color: '#4EAA25', bg: 'rgba(78,170,37,0.10)' },
  'Kafka': { iconName: 'SiApachekafka', color: '#231F20', bg: 'rgba(100,100,100,0.10)' },
  'Terraform': { iconName: 'SiTerraform', color: '#7B42BC', bg: 'rgba(123,66,188,0.10)' },
  'AWS': { iconName: 'SiAmazonwebservices', color: '#FF9900', bg: 'rgba(255,153,0,0.10)' },
  'CI/CD': { iconName: 'SiGithubactions', color: '#2088FF', bg: 'rgba(32,136,255,0.10)' },
  'GitHub Actions': { iconName: 'SiGithubactions', color: '#2088FF', bg: 'rgba(32,136,255,0.10)' },
};
